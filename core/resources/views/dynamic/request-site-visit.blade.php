                    ...
                    <div class="contactform_wrap">
                        ...
                        <div class="form-group">
                            <div class="input_group">
                                ...
                                <div class="input_group_item">
                                    <input type="text" name="cityDesc" value="{{ old('cityDesc') }}" placeholder="City"
                                        class="form-control @error('cityDesc') is-invalid @enderror">
                                    @error('cityDesc')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            <select name="udF_17" class="form-select @error('udF_17') is-invalid @enderror">
                                <option value="" disabled @selected(!old('udF_17'))>Planned Timeline for Purchase
                                </option>
                        ...
                        <div class="form-group">
                            <input type="text" name="udF_6" value="{{ old('udF_6') }}"
                                ...
                                placeholder="Preferred Site Visit Date & Time" onfocus="this.type='date'"

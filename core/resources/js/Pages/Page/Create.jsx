                    ...
                    <div className="card-body">
                        <div className="row">
                            ...
                            <div className="mb-3 col-md-6">
                                ...
                                <div className="form-text">
                                    If the slug is empty it will be
                                    automatically generated by title
                                </div>
                            </div>
                            ...
                            <div className="mb-3 col-md-6">
                                ...
                                <div className="form-text">
                                    If a redirect URL is specified, the page
                                    will automatically redirect to the specified
                                    URL.
                                </div>
                            </div>
                            ...
                            <div className="mb-3 col-md-4">
                                ...
                                <div className="form-text">
                                    Select one or more locations where this page
                                    should appear
                                </div>
                            </div>
